...
// import { deleteCourse, getAllCourses } from "../../Redux/courseSlice";
// import { getStatsData } from "../../Redux/statSlice";
// // --- FIX: Import the new thunk ---
// import { fetchAllPayments } from "../../Redux/razorpaySlice";
...
//   // --- FIX: Read 'allPayments' from the slice. It's now just an array. ---
//   const { allPayments } = useSelector((state) => state.razorpay);

//   // --- FIX: Calculate total revenue manually (assuming price is needed)
//   // For simplicity, we'll just show the count of payments.
//   // The 'allPayments' array from the backend controller doesn't include revenue.
//   const totalPaymentsCount = allPayments ? allPayments.length : 0;
//   // We can't calculate total revenue easily anymore without more data.
//   // We will display a placeholder or just the count.
...
//       {
//         label: "Sales / Month",
//         // This data is no longer available from the new backend, so we pass an empty array
//         data: [], 
//         backgroundColor: ["rgb(255, 99, 132)"],
//         borderColor: ["white"],
//         borderWidth: 2,
...
//   const { courseList: myCourses } = useSelector((state) => state.course);
...
//               <div className="flex items-center justify-between py-5 px-5 gap-5 rounded-md shadow-md">
//                 <div className="flex flex-col items-center">
//                   <p className="font-semibold">Payments Count</p>
//                   {/* --- FIX: Use totalPaymentsCount --- */}
//                   <h3 className="text-4xl font-bold">{totalPaymentsCount}</h3>
//                 </div>
//                 <FcSalesPerformance className="text-yellow-500 text-5xl" />
//               </div>
...
//                 <div className="flex flex-col items-center">
//                   <p className="font-semibold">Total Revenue</p>
//                   {/* --- FIX: Data is unavailable, show N/A --- */}
//                   <h3 className="text-4xl font-bold">N/A</h3>
//                 </div>
//                 <GiMoneyStack className="text-green-500 text-5xl" />
//               </div>
//             </div>
...
//             <tbody>
//               {/* --- FIX: Map over myCourses (which is now courseList) --- */}
//               {myCourses?.map((element, index) => {
//                 return (
//                   <tr key={element?._id}>
//                     <td>{index + 1}</td>
...
//                           navigate("/course/create", {
//                             state: {
//                               // Note: Your CreateCourse page might not support this state
//                               // This is old logic.
//                             },
//                           })
//                         }
