...
function CreateCourse() {
  ...
  async function onFormSubmit(e) {
    ...
    if (
      ...
      !userInput.category ||
      !userInput.createdBy ||
      !userInput.price // Add price validation
    ) {
      toast.error('All fields are mandatory');
      return;
    }
    ...
    formData.append('price', userInput.price); // Append price
        ...
        >
          ...
          <main className="grid grid-cols-2 gap-x-10">
            ...
            <div className="gap-y-6">
              {/* ... (Thumbnail input remains the same) ... */}
              <div>
          ...
          <button
            type="submit"
            className="w-full py-2 text-lg font-semibold rounded-sm bg-yellow-600 hover:bg-yellow-500 transition-all ease-in-out duration-300"
          >
            Create Course
          </button>
        </form>
